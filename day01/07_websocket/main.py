...
# WebSocketHandler will track open connections
class WebSocketHandler(tornado.websocket.WebSocketHandler):
    connections = set()  # Class-level set to track connections
    ...
    def open(self):
        ...
        WebSocketHandler.connections.add(self)  # Add connection
    ...
    def on_close(self):
        ...
        WebSocketHandler.connections.remove(self)  # Remove connection
